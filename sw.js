...
const CACHE_NAME = 'ferrisoluciones-pos-v3-11-30';
const RUNTIME_CACHE = 'ferrisoluciones-runtime-v3-11-30';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/pc/index.html',
    '/pc/manifest.json',
    '/pc/css/styles.css?v=3.11.30',
...
self.addEventListener('install', (event) => {
    console.log('🔧 [SW] Installing Service Worker v3.11.30...');
...
self.addEventListener('activate', (event) => {
    console.log('🚀 [SW] Activating Service Worker v3.11.30...');
...
self.addEventListener('fetch', (event) => {
    ...
    // Network First Strategy. 'no-store' fuerza a saltar el cache HTTP del
    // navegador (no solo el de este service worker): sin esto, fetch(request)
    // puede resolverse con una copia en disco vieja de app.js/styles.css sin
    // ni siquiera tocar la red, y una actualizacion nueva no se nota hasta
    // que esa copia expira (GitHub Pages manda Cache-Control: max-age=600).
    event.respondWith(
...
console.log('✅ Service Worker v3.11.30 loaded (Network First Strategy)');
