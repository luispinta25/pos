...
const CACHE_NAME = 'ferrisoluciones-pos-v3-8-0';
const RUNTIME_CACHE = 'ferrisoluciones-runtime-v3-8-0';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/pc/index.html',
...
console.log('✅ Service Worker v3.8.0 loaded (Network First Strategy)');
