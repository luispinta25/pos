...
const CACHE_NAME = 'ferrisoluciones-pos-v3-11-15';
const RUNTIME_CACHE = 'ferrisoluciones-runtime-v3-11-15';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/pc/index.html',
    '/pc/manifest.json',
    '/pc/css/styles.css?v=3.11.15',
...
self.addEventListener('install', (event) => {
    console.log('🔧 [SW] Installing Service Worker v3.11.15...');
...
self.addEventListener('activate', (event) => {
    console.log('🚀 [SW] Activating Service Worker v3.11.15...');
...
console.log('✅ Service Worker v3.11.15 loaded (Network First Strategy)');
