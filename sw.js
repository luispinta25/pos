...
self.addEventListener('install', (event) => {
    console.log('🔧 [SW] Installing Service Worker v3.11.7...');
...
self.addEventListener('activate', (event) => {
    console.log('🚀 [SW] Activating Service Worker v3.11.7...');
...
console.log('✅ Service Worker v3.11.7 loaded (Network First Strategy)');
