...
const CACHE_NAME = 'ferrisoluciones-pos-v3-11-0';
const RUNTIME_CACHE = 'ferrisoluciones-runtime-v3-11-0';
const STATIC_ASSETS = [
    '/',
    '/index.html',
    '/pc/index.html',
    '/pc/manifest.json',
    '/pc/css/styles.css?v=3.11.0',
...
console.log('✅ Service Worker v3.11.0 loaded (Network First Strategy)');
