...
self.addEventListener('install', (event) => {
    console.log('🔧 [SW] Installing Service Worker v3.9.3...');
...
self.addEventListener('activate', (event) => {
    console.log('🚀 [SW] Activating Service Worker v3.9.3...');
...
console.log('✅ Service Worker v3.9.3 loaded (Network First Strategy)');
